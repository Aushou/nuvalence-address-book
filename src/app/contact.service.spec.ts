...
describe('ContactService', () => {
  ...
  describe('Get Contacts', () => {
    it('should return an Observable of a list of contacts on success', () => {
      ...
      const req = httpTestingController.expectOne('https://randomuser.me/api/?results=100&seed=nuvalence&inc=name,picture,phone,cell,login');
  ...
  describe('Get Contacts Paginated', () => {
    it('should return an Observable of a list of contacts on success', () => {
      ...
      const req = httpTestingController
        .expectOne('https://randomuser.me/api/?seed=nuvalence&inc=name,picture,phone,cell,login&page=1&results=5');
      expect(req.request.method).toBe('GET');
      req.flush(mockContacts);
    });
    ...
    it('should create the correct query params from the input params', () => {
      ...
      const req = httpTestingController
        .expectOne(`https://randomuser.me/api/?seed=nuvalence&inc=name,picture,phone,cell,login&page=${givenPage+1}&results=${givenSize}`);
      expect(req.request.method).toBe('GET');
      req.flush(mockContacts);
    })
